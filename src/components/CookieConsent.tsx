...
const CookieConsent = ({ onAccept }: CookieConsentProps) => {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-md">
      ...
      >
        <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-cyber-blue via-cyber-purple to-cyber-pink opacity-75 blur-sm" />
        
        <div className="relative rounded-xl bg-gray-900 p-6 shadow-neon border border-white/20">
          <div className="flex justify-center mb-4">
            <div className="p-3 rounded-full bg-cyber-purple/30 border border-cyber-purple/50">
          ...
          <div className="space-y-4 mb-6">
            ...
            <ul className="space-y-2 text-sm text-gray-200">
              <li className="flex items-start">
                <span className="bg-cyber-purple/30 p-1 rounded-full mr-2 flex-shrink-0">
